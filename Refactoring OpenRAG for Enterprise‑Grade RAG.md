...
1. Generic Registry
      ...
      The Registry is the backbone of the plugin system.

1. Cached Component Factory

[OPENRAG_NEW_ARCHITECTURE](https://www.notion.so/OPENRAG_NEW_ARCHITECTURE-33462718bad1808591e6c5257f1dead4?pvs=21)