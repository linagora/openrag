...
class CommonSearchParams:
    def __init__(
        ...
        similarity_threshold: float = Query(0.75, description="Minimum similarity score for results (0 to 1)"),
...
async def search_file(
    ...
    if search_params.filter_params:
        params.update(search_params.filter_params)
