...
_PATCHES = [
    patch("services.workers.loaders.doc.Document"),
    patch("services.workers.loaders.doc.DocxLoader"),
    patch("services.workers.loaders.base.ChatOpenAI"),
    patch("services.workers.loaders.base.load_config"),
]
...
class TestDocLoader:
    ...
    def _make_loader(self, mock_config):
        ...
        from services.workers.loaders.doc import DocLoader
