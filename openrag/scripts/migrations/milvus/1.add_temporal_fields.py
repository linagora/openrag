...
==============================================================
Adds the following TIMESTAMPTZ fields (nullable) to the existing collection:
    - datetime
    - created_at
    - updated_at
    - indexed_at

Each field also gets an STL_SORT index.  After a successful upgrade the
...
FIELDS_2_ADD = [
    {"field_name": "datetime", "data_type": DataType.TIMESTAMPTZ, "nullable": True},
    {"field_name": "created_at", "data_type": DataType.TIMESTAMPTZ, "nullable": True},
    {"field_name": "updated_at", "data_type": DataType.TIMESTAMPTZ, "nullable": True},
    {"field_name": "indexed_at", "data_type": DataType.TIMESTAMPTZ, "nullable": True},
]

INDEXES_2_ADD = [
    {"field_name": "datetime", "index_type": "STL_SORT", "index_name": "datetime_idx"},
    {"field_name": "created_at", "index_type": "STL_SORT", "index_name": "created_at_idx"},
    {"field_name": "updated_at", "index_type": "STL_SORT", "index_name": "updated_at_idx"},
    {"field_name": "indexed_at", "index_type": "STL_SORT", "index_name": "indexed_at_idx"},
]
...
def main() -> None:
    ...
    cfg = load_config()
    host = cfg.vectordb.get("host")
    port = cfg.vectordb.get("port")
    collection_name = cfg.vectordb.get("collection_name", "vdb_test")
