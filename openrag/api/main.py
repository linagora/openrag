...
from api.routers.indexer import router as indexer_router
from api.routers.monitoring import MonitoringMiddleware
from api.routers.monitoring import router as monitoring_router
from api.routers.openai import router as openai_router
from api.routers.partition import router as partition_router
...
from api.routers.utils import require_admin
from api.routers.workspaces import router as workspaces_router
from starlette.middleware.base import BaseHTTPMiddleware
from di.dependencies import get_vectordb
...
if __name__ == "__main__":
    if config.ray.serve.enable:
        ...
        uvicorn.run("api.main:app", host="0.0.0.0", port=8080, reload=True, proxy_headers=True)
